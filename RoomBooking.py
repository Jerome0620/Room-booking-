...
Label(top, text='Hotel Davies', font=('Arial', 18)).grid(row=0, column=0, columnspan=2, padx=80, pady=20)
...
def Book():
    ...
    Label(top1, text='Room No:', font=('Arial', 12)).grid(row=2, column=0, padx=10, pady=10, sticky='w')
...
def ViewHistory():
    ...
    Label(top2, text='Room No', font=('Arial', 12), borderwidth=1, relief="solid", width=20).grid(row=0, column=1, pady=10)
    Label(top2, text='Date of Booking', font=('Arial', 12), borderwidth=1, relief="solid", width=20).grid(row=0, column=2, pady=10)
    Label(top2, text='Validity(Date)', font=('Arial', 12), borderwidth=1, relief="solid", width=20).grid(row=0, column=3, pady=10)
...
def DeleteBooking():
    ...
    Label(top3, text='Room No', font=('Arial', 12), borderwidth=1, relief="solid", width=20).grid(row=0, column=1, pady=10)
    Label(top3, text='Date of Booking', font=('Arial', 12), borderwidth=1, relief="solid", width=20).grid(row=0, column=2, pady=10)
    Label(top3, text='Validity(Date)', font=('Arial', 12), borderwidth=1, relief="solid", width=20).grid(row=0, column=3, pady=10)
...
# defining buttons
Button(top, text='Room Booking', font=('Arial', 14), fg='white', command=lambda:Book(), width=12, height=2, bg='navy').grid(row=1, column=0, padx=80, pady=20)

Button(top, text='View History', font=('Arial', 14), fg='white', command=lambda:ViewHistory(), width=12, height=2, bg='navy').grid(row=1, column=1, pady=20)

Button(top, text='Delete Booking', font=('Arial', 14), fg='white', command=lambda:DeleteBooking(), width=12, height=2, bg='navy').grid(row=2, column=0, pady=30)

Button(top, text='Quit', font=('Arial', 14), fg='white', command=lambda:top.destroy(), width=12, height=2, bg='navy').grid(row=2, column=1, pady=30)
